...
class MenuListAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.txtText.setText(PetList.Pet_name.get(position));
			holder.txtSubText.setText(PetList.string);
			
			imageLoader.DisplayImage(Utils.serverUrl + PetList.Pet_image.get(position),
